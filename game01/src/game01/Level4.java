...
public class Level4 {
	...
	public void createUI() {
		JFrame window = new JFrame("던전 Lv.4");
		...
		ImageIcon Mon1 = new ImageIcon(getClass().getClassLoader().getResource("Mon4.png"));
    	...
    	ImageIcon icon1 = new ImageIcon(Frame.class.getResource("/image/dungeon5.jpg"));
