...
public class Level1 {
	...
	public void createUI() {
		JFrame window = new JFrame("던전 Lv.1");
		...
		ImageIcon Mon1 = new ImageIcon(getClass().getClassLoader().getResource("Mon1.jpg"));
    	...
    	ImageIcon icon1 = new ImageIcon(Frame.class.getResource("/image/dungeon2.jpg"));
	...
	public class MouseHandler implements MouseListener{
		...
		public void mouseEntered(MouseEvent e) {
			...
			if(button == button1) {
				...
				if(StingUnlocked==false) {
					messageText.setText("잠겨있습니다! 200 Gold 필요!");
				}
				else {
					messageText.setText("스팅\n[지불: "+ StingPrice +" Gold]\n1초당 대미지 + 5");
				}
