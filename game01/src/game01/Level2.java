...
public class Level2 {
	...
	public void createUI() {
		JFrame window = new JFrame("던전 Lv.2");
		...
		ImageIcon Mon1 = new ImageIcon(getClass().getClassLoader().getResource("Mon2.png"));
    	...
    	ImageIcon icon1 = new ImageIcon(Frame.class.getResource("/image/dungeon3.jpg"));
