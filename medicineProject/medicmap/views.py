...
def district_graph(request):
    ...
    fig = px.scatter(df_mpg2, x='시군구명', y='n', labels={'n': '수'}, title='scatter Chart')
...
def medical_institution_types(request):
    ...
    fig = px.line(df_mpg1, x='종별명', y='n', labels={'n': '수'}, title='line Chart')
    ...
    fig = px.bar(df_mpg2, x='n', y='종별명', labels={'n': '수'}, title='graph Chart')
    plot_html2 = fig.to_html(full_html=False)
